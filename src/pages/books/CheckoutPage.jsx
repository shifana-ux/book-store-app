...
const CheckoutPage = () => {
    ...
    // const currentUser = true; // TODO: use getuse from auth
    ...
    const {
          ...
          console.log('useCreateOrderMutation:', useCreateOrderMutation);
  ...
  return (
    ...
    <div className="container max-w-screen-lg mx-auto">
        <div>
            <div>
            <h2 className="font-semibold text-xl text-gray-600 mb-2">Cash On
                 Delevary</h2>
            ...
            <div className="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                <h3 className="font-semibold text-lg text-gray-600 mb-4">Cart Items</h3>
                <div className="space-y-4">
                    {cartItems.map((item) => (
                        <div key={item._id} className="flex items-center space-x-4 border-b pb-4">
                            <img src={item.imageURL} alt={item.bookTitle} className="w-20 h-20 object-cover rounded" />
                            <div>
                                <h4 className="font-medium">{item.bookTitle}</h4>
                                <p className="text-gray-500">Price: ${item.newPrice}</p>
                            </div>
                        </div>
                    ))}
                </div>
            ...
            </div>
            {
             ...
             cartItems.length > 0 && (<div className="bg-white rounded shadow-lg
               p-4 px-4 md:p-8 mb-6">
                    <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4
                     gap-y-2 text-sm grid-cols-1 lg:grid-cols-3 my-8">
                            ...
                            <div className="grid gap-4 gap-y-2 text-sm grid-cols-1
                             md:grid-cols-5">
                                <div className="md:col-span-5">
                                    ...
                                    className="h-10 border mt-1 rounded px-4
                                     w-full bg-gray-50"  />
                                </div>
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <input
                                       {...register("city", { required: true })}
                                        type="text" name="city" id="city" className="h-10 border mt-1 rounded px-4
                                         w-full bg-gray-50" placeholder="" />
                                </div>
                                ...
                                <div className="md:col-span-5 mt-3">
                                    <div className="inline-flex items-center">
                                        ...
                                        <label htmlFor="billing_same"
                                         className="ml-2 ">I am aggree to the <Link
                                          className='underline underline-offset-2
                                           text-blue-600'>Terms & Conditions</Link>
                                            and <Link className='underline underline-offset-2 text-blue-600'
                                            >Shoping Policy.</Link></label>
                                    </div>
                                </div>
